...
func init() {
	...
	md_Identity = File_identity_identity_identity_proto.Messages().ByName("Identity")
...
func (x *Identity) slowProtoReflect() protoreflect.Message {
	mi := &file_identity_identity_identity_proto_msgTypes[0]
...
func (x *fastReflection_Identity) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "identity.identity.Identity.id":
		return x.Id != uint64(0)
	case "identity.identity.Identity.creator":
		return x.Creator != ""
	case "identity.identity.Identity.name":
		return x.Name != ""
	case "identity.identity.Identity.birthdate":
		return x.Birthdate != ""
	case "identity.identity.Identity.nationalId":
		return x.NationalId != ""
	case "identity.identity.Identity.verified":
		return x.Verified != false
	case "identity.identity.Identity.did":
		return x.Did != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: identity.identity.Identity"))
		}
		panic(fmt.Errorf("message identity.identity.Identity does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Identity) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message identity.identity.Identity does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Identity) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "identity.identity.Identity.id":
		panic(fmt.Errorf("field id of message identity.identity.Identity is not mutable"))
	case "identity.identity.Identity.creator":
		panic(fmt.Errorf("field creator of message identity.identity.Identity is not mutable"))
	case "identity.identity.Identity.name":
		panic(fmt.Errorf("field name of message identity.identity.Identity is not mutable"))
	case "identity.identity.Identity.birthdate":
		panic(fmt.Errorf("field birthdate of message identity.identity.Identity is not mutable"))
	case "identity.identity.Identity.nationalId":
		panic(fmt.Errorf("field nationalId of message identity.identity.Identity is not mutable"))
	case "identity.identity.Identity.verified":
		panic(fmt.Errorf("field verified of message identity.identity.Identity is not mutable"))
	case "identity.identity.Identity.did":
		panic(fmt.Errorf("field did of message identity.identity.Identity is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: identity.identity.Identity"))
		}
...
func (x *fastReflection_Identity) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in identity.identity.Identity", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Identity) Descriptor() ([]byte, []int) {
	return file_identity_identity_identity_proto_rawDescGZIP(), []int{0}
}
...
var File_identity_identity_identity_proto protoreflect.FileDescriptor

var file_identity_identity_identity_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x11, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x69, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0xb4, 0x01, 0x0a, 0x08, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	...
	0x0a, 0x0a, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x1a,
	0x0a, 0x08, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x08, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x69,
	0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x69, 0x64, 0x42, 0xaf, 0x01, 0x0a,
	0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x69, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x0d, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79,
...
var (
	file_identity_identity_identity_proto_rawDescOnce sync.Once
	file_identity_identity_identity_proto_rawDescData = file_identity_identity_identity_proto_rawDesc
)

func file_identity_identity_identity_proto_rawDescGZIP() []byte {
	file_identity_identity_identity_proto_rawDescOnce.Do(func() {
		file_identity_identity_identity_proto_rawDescData = protoimpl.X.CompressGZIP(file_identity_identity_identity_proto_rawDescData)
	})
	return file_identity_identity_identity_proto_rawDescData
}

var file_identity_identity_identity_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_identity_identity_identity_proto_goTypes = []interface{}{
	(*Identity)(nil), // 0: identity.identity.Identity
}
var file_identity_identity_identity_proto_depIdxs = []int32{
...
func init() { file_identity_identity_identity_proto_init() }
func file_identity_identity_identity_proto_init() {
	if File_identity_identity_identity_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_identity_identity_identity_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_identity_identity_identity_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_identity_identity_identity_proto_goTypes,
		DependencyIndexes: file_identity_identity_identity_proto_depIdxs,
		MessageInfos:      file_identity_identity_identity_proto_msgTypes,
	}.Build()
	File_identity_identity_identity_proto = out.File
	file_identity_identity_identity_proto_rawDesc = nil
	file_identity_identity_identity_proto_goTypes = nil
	file_identity_identity_identity_proto_depIdxs = nil
}
